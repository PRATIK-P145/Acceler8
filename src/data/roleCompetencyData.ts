...
export const ROLE_PROFILES: Role[] = [
  ...
  role(
    ...
    [
      ...
      ["data-quality", 5, "Core"],
      ["descriptive-statistics", 4, "Core"],
      ["official-statistics-indicators", 5, "Core"],
  ...
  role(
    ...
    [
      ["sql-data-management", 4, "Core"],
      ["data-architecture", 5, "Core"],
      ["data-integration-apis", 5, "Core"],
      ["cloud-fundamentals", 4, "High"],
      ["reproducible-computing", 3, "Supporting"],
      ["data-privacy", 4, "Core"],
  ...
  role(
    ...
    [
      ...
      ["statistical-modeling", 5, "Core"],
      ["research-methodology", 5, "Core"],
      ["data-quality", 4, "High"],
